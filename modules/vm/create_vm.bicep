...
resource r_attachMetricsPublisherPermsToRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('r_attachMetricsPublisherPermsToRole', r_userManagedIdentity.id, metricsPublisherRoleId)
  scope: resourceGroup()
  properties: {
...
// Add Storage Queue Contributor Role to the custom identity
